...
\begin{itemize}
    ...
    \begin{center}
            \includegraphics[width=\columnwidth]{images/module_size.png}
    \end{center}
...
De plus, la standardisation mécanique permet d'envisager la generation automatique de pièce mécanique permettant de fixed n modules entre eux. Pour ces aspects, des discussions sont en cours avec Sylvain Lefevbre (Inria Nancy) autour de ShapeForge.
}
...
\begin{itemize}
    ...
    \item \textbf{Rapide:} Avec la norme FastMode+, l'i2C pour être utilisé à 3,4Mbaud.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Librairie multilangage :} La bibliothèque de controle de Poppy pourra être utiliser avec différents langages.
...
\begin{center}
        \includegraphics[width=0.9\columnwidth]{images/module_moteur.png}
\end{center}
